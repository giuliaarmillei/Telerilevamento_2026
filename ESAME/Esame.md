...
```r
im.multiframe(3, 4)   #suddivisione finestra grafica in 3 righe e 4 colonne
...
# assegnazione dei nomi agli elementi dello stack
...
| :--- | :---: | :---: | :---: |
| **Vegetazione** | 32.39% | 23.13% | 28.42% |
| **Suolo nudo** | 29.50% | 42.10% | 36.9% |
| **Vegetazione rada** | 38.11% | 34.77% | 34.66% |
...
<img width="900" height="600" alt="istogramma" src="https://github.com/user-attachments/assets/8c9fcac6-c18f-415c-8b7b-0ba03e12f470" />
